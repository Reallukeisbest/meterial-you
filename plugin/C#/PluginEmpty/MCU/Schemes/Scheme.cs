...
public partial class Scheme<TColor>
{
    ...
    public IDictionary<string, string> getAsJson()
    {
        ...
        this.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public)
          ...
          {
              System.UInt32 value = (System.UInt32)prop.GetValue(this, null);
              schemeTheme.Add(prop.Name, hexToRGB("#" + value.ToString("X6").Substring(2)));
              return value;
          });
